...
a_c = pd.read_csv('../SUBTLEX/result-sheets/stemming/SUBTLEX_USfrequency_above1_result.csv')
c_g = pd.read_csv('../SUBTLEX/result-sheets/stemming/SUBTLEX_USfrequency_above2_result.csv')
g_m = pd.read_csv('../SUBTLEX/result-sheets/stemming/SUBTLEX_USfrequency_above3_result.csv')
m_r = pd.read_csv('../SUBTLEX/result-sheets/stemming/SUBTLEX_USfrequency_above4_result.csv')
r_t = pd.read_csv('../SUBTLEX/result-sheets/stemming/SUBTLEX_USfrequency_above5_result.csv')
t_z = pd.read_csv('../SUBTLEX/result-sheets/stemming/SUBTLEX_USfrequency_above6_result.csv')
                    ...
                    if line:
                        ...
                        for sentences in dicts:
                            for word in sentences:
                                ...
                                row.append(lancaster.stem(token_word))
                                row.append(extract_subtlex(lancaster.stem(token_word)))
                                csv_data.append(row)
                                row = []
